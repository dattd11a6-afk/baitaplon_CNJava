...
<head>
    ...
    <style>
        ...
        .op-card { background: var(--surface); border: 1px solid var(--border-color); border-radius: 12px; padding: 20px; }
        ...
        .staff-table td { padding: 16px; vertical-align: middle; border-bottom: 1px solid var(--border-color); color: #17231A; }
        .badge-status { padding: 6px 12px; border-radius: 6px; font-weight: 500; font-size: 12px; }
        .bg-pending { background: #FEF3C7; color: #B45309; } .bg-processing { background: #DBEAFE; color: #1D4ED8; } .bg-success-soft { background: #DCFCE7; color: #15803D; }
...
<div class="d-flex">
    ...
    <main class="flex-grow-1 overflow-auto" style="height: 100vh;">
        <header class="topbar border-0 mb-3"><div class="fw-medium fs-5"><i class="ph ph-receipt me-2 text-primary"></i>Đơn hàng cần xử lý</div></header>
        <div class="p-4">
