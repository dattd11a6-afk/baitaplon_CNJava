...
<head>
    ...
    <style>
        ...
        .product-thumbnail { width: 35px; height: 35px; border-radius: 6px; object-fit: cover; border: 1px solid var(--border-color); background: #FAFAFA;}
...
<div class="d-flex">
    ...
    <main class="flex-grow-1 overflow-auto" style="height: 100vh;">
        <header class="topbar border-0 mb-3"><div class="fw-medium fs-5"><i class="ph ph-package me-2 text-primary"></i>Tra cứu Tồn kho</div></header>
        <div class="p-4">
