    ...
    <main class="flex-grow-1 d-flex flex-column" style="height: 100vh; overflow-y: auto;">
        ...
        <div class="p-4 px-5">
            <div class="d-flex justify-content-between align-items-end mb-4">
                ...
                <button class="btn btn-success fw-medium" data-bs-toggle="modal" data-bs-target="#addCategoryModal"><i class="ph-bold ph-plus me-1"></i> Thêm danh mục</button>
            </div>

            <div class="admin-card p-0">
                <table class="admin-table mb-0">
                    <thead><tr><th style="width: 80px;">ID</th><th>Tên danh mục</th><th>Mô tả</th><th>Trạng thái</th><th class="text-end">Thao tác</th></tr></thead>
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-btns">
                                        <button class="btn-icon edit text-primary" data-bs-toggle="modal" data-bs-target="#editCategoryModal${c.id}" title="Sửa danh mục"><i class="ph-bold ph-pencil-simple"></i></button>
                                        <form action="${pageContext.request.contextPath}/admin/categories" method="POST" class="m-0 p-0" onsubmit="return confirm('Bạn có chắc chắn muốn xóa/ẩn danh mục [${c.name}] không?');">
                                            ...
                                            <button type="submit" class="btn-icon delete text-muted" title="Xóa"><i class="ph-bold ph-trash"></i></button>
                                        </form>
                                    </div>
                                </td>
                            </tr>
    ...
    <div class="modal-dialog modal-dialog-centered"><div class="modal-content border-0 rounded-4 shadow">
        ...
        <form action="${pageContext.request.contextPath}/admin/categories" method="POST">
            <div class="modal-body text-start">
                ...
                <div class="mb-3"><label class="form-label fw-medium">Tên danh mục <span class="text-danger">*</span></label><input type="text" name="name" class="form-control" required></div>
                <div class="mb-3"><label class="form-label fw-medium">Mô tả</label><textarea name="description" class="form-control" rows="3"></textarea></div>
